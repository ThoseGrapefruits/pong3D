  ...
  (cond [(not active-menu-item) empty-pict3d]
        [else
         (combine
          ...
          (render-menu-item-active s menu active-menu-item))]))

(define TEXT-SCALE 0.06)

(: render-menu-item-active : State-Main-Menu Menu Menu-Item -> Pict3D)
(define (render-menu-item-active s menu menu-item)
