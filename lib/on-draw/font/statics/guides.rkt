...
(: LINE/MID-Y/END-3/8 : Pos)
(define LINE/MID-Y/END-3/8 (pos+ LINE/MID-Y/START +x WIDTH-EM-3/8))
...
(: LINE/MID-FULL/END-3/8 : Pos)
(define LINE/MID-FULL/END-3/8 (pos+ LINE/MID-FULL/START +x WIDTH-EM-3/8))
