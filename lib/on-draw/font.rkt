  ...
  (Char-3D #\j WIDTH-EM-3/8
           (λ () (combine
                  ...
                  (move-x (arc-desc-3/8 #:arc (arc 0.0 90.0))
                          (- WIDTH-STROKE))))))
(define char:k
  (Char-3D #\k WIDTH-EM-5/8 (λ () (combine
                                   ; ascender
...
(define char:w
  (Char-3D #\w WIDTH-EM-5/8 (λ () (cube LINE/MID-X/CENTER-1/2 WIDTH-EM-1/4))))
(define char:x
  (Char-3D #\x WIDTH-EM-5/8 (λ () (cube LINE/MID-X/CENTER-1/2 WIDTH-EM-1/4))))
(define char:y
  (Char-3D #\y WIDTH-EM-5/8 (λ () (cube LINE/MID-X/CENTER-1/2 WIDTH-EM-1/4))))
(define char:z
  (Char-3D #\z WIDTH-EM-1/2
           (λ ()
             ...
             (combine
              ...
              (quad cf-top-outer
                    cf-top-inner
                    (pos+ cf-top-inner +z DEPTH-Z)
                    (pos+ cf-top-outer +z DEPTH-Z))
              ; cross — front
              (quad cf-top-outer
                    cf-top-inner
                    cf-bottom-outer
                    cf-bottom-inner)
              ; cross — bottom
              (quad cf-bottom-outer
                    cf-bottom-inner
                    (pos+ cf-bottom-inner +z DEPTH-Z)
                    (pos+ cf-bottom-outer +z DEPTH-Z))
